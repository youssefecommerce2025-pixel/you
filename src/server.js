...
// CORS : autorise le frontend (heberge sur un autre domaine) a appeler l'API.
// Definis ALLOWED_ORIGINS = "https://mon-frontend.fr,https://autre.fr" (ou "*").
...
// Sert aussi les pages statiques si le dossier public existe (mode monolithe optionnel).
